...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post lectures_url, params: { lecture: { attachment: @lecture.attachment, content: @lecture.content } }
  #   end
  ...
  #   patch lecture_url(@lecture), params: { lecture: { attachment: @lecture.attachment, content: @lecture.content } }
